undefine usuario
ACCEPT usuario PROMPT 'Informe o seu usuário: ' 
...
SET SERVEROUTPUT ON
EXECUTE dbms_stats.gather_schema_stats( UPPER('&usuario') , granularity => 'ALL' ,cascade => TRUE , block_sample => TRUE);
...
select object_name,object_type,to_char(created,'dd/mm/rrrr hh24:mi:ss') created,status
from user_objects
order by 2,1;
